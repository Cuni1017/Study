...
$sql = "SELECT `company_id`, `company_name`, `company_username`, `company_password`, `company_number`, `company_email`, `company_money`, `company_time`, `company_place`, `company_content`, `company_work_experience`, `company_type`, `company_Education`, `company_department`, `company_other`, `company_safe`, `level` FROM `company` where `company_id` ='".$rel_company_id."' ";
            ...
            <?php while ($stmt->fetch()) { ?>
                ...
                <div id="job_Content">
                    ...
                    <div class="bottom_row">
                        <a class="btn" href="student_email_controll.php?user_id=<?= $user_id ?>&company_id=<?= $rel_company_id ?>">我要應徵</a>
                    </div>
                </div>
            <?php } ?>
        </div> <!-- content -->
